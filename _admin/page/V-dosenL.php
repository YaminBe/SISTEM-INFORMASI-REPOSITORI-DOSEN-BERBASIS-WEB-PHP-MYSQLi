<div class="panel box-shadow-none content-header">
  <div class="panel-body">
    <div class="col-md-12">
        <h3 class="animated fadeInLeft">laporan Dosen</h3>
        <p class="animated fadeInDown">
          Laporan<span class="fa-angle-right fa"></span> Laporan Data Dosen
        </p>
    </div>
  </div>
</div>
...
<div class="col-md-12">
  <div class="panel">
    <div class="panel-heading"><a href="../laporan/lap-dosen-all.php" target="_blank" class="btn btn-danger pull-right"> <span class="fa fa-download"></span> Download</a><h3><h3> Tampil Data Dosen</h3></div>
    <div class="panel-body">
                    ...
                    <!--       		<td><?php echo $data['alamat'] ?></td> -->
                              ...
                              <td>
                                <?php 
                          		...
                          		<td>
                                <a href="?page=detail-dsn&id= <?php echo $data['id_dosen']; ?> " class="btn btn-info"> <span class="fa fa-search"></span> Detail</a>
                                <a href="../laporan/lap-dosen-perid.php?id= <?php echo $data['id_dosen']; ?> " target="_blank" class="btn btn-success"> <span class="fa fa-print"></span> Cetak</a>
                          		</td>
                          	</tr>
                          <?php
                           } ?>

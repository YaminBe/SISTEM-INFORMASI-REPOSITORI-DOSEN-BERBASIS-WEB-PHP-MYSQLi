                        ...
                        <form class="cmxform" id="signupForm" method="POST" action="?page=proses">
                          ...
                          <div class="col-md-12">
                            <div class="form-group form-animate-text">
                              <input type="text" name="pengarang" class="form-text" id="validate_firstname" required>
                              <span class="bar"></span>
...
?>
                            ...
                            <div class="form-group form-animate-text">                            	
                              <input type="hidden" name="id_dosen" value="<?php echo $data['id_dosen'] ?>">
                               <input type="text" class="form-text" id="validate_password" name="penerbit" value="<?php echo $data['id_prodi'] ?>">
                              <span class="bar"></span>

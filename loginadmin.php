...
<head>
  ...
  <title>Login Administrator || Repository</title>
        ...
        <form class="form-signin" action="" method="post">
          <div class="panel periodic-login">
              <div class="panel-body text-center">
                 ...
                 <img src="logo.jpg" alt="" style="border-radius: 15px;width: 100px;"> -->
                 <img src="logo.jpg" alt="" style="border-radius: 15px;width: 50px;">
                  <h1>Repository</h1>
                  <!-- <p class="atomic-mass">14.072110</p> -->
                  
                  <p class="element-name">Login Admin</p>
...
include "koneksi.php";
$sqlLogin = mysqli_query($konek, "SELECT * FROM tb_user WHERE username ='$user' AND password='$pass'");
